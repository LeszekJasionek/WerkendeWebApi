        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeeMail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CSN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeePeople", x => x.PersonId);
                });
        }
